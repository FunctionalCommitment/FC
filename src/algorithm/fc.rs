...
pub fn open(pp:FCpp, kzgpp: &KZGpp, b_vec: Vec<FrRepr>, a_vec:Vec<G1Affine>)-> PI {
    let n = pp.v_vec.len();
 ...
 pub fn verify(pp:&FCpp, kzgpp: &KZGpp, com:Fq12, b_vec: Vec<FrRepr>, y: G1Affine, pi:&PI)-> bool {
