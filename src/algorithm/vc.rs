...
pub fn com(pp:&VCpp, a_vec:&Vec<G1Affine>)-> Fq12 {
   let com = Bls12::pairing_multi_product(&a_vec, &pp.v_vec);
   
   com
}

pub fn open(pp:VCpp, i: &usize, a_vec:Vec<G1Affine>)-> PI {
    let n = pp.v_vec.len();
 ...
 pub fn verify(pp:&VCpp, com:Fq12, i:&usize, a_i: G1Affine, pi:&PI)-> bool {
